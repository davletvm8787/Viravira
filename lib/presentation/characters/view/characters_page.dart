...
import '../../../app/resource/value_manager.dart';

class CharactersPageDetailPage extends StatelessWidget {
  CharactersPageDetailPage({
    super.key,
  });
  ...
  Widget _body(CharactersViewModel watch, CharactersViewModel read) {
    return watch.characterList.getScreenWidget(
      errorWidget: (failure) => ErrorStateWidget(
        errorMessage: failure.serverMessage ?? failure.message,
        buttonOnClick: () {
